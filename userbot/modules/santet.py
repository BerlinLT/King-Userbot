...
async def typewriter(typew):
    ...
    sleep(2)
    await typew.edit("`cari yg gudloking dulu...🔍`")
    sleep(1)
    await typew.edit("`pelet Online Segera Dilakukan,Hati Hati Nanti Baper`")
    sleep(1)
    await typew.edit("0%")
    number = 1
    await typew.edit(str(number) + "%   ▎")
    ...
    await typew.edit(str(number) + "%   ████████████████▌")
    sleep(1)
    await typew.edit("`Target kena pelet Online,awas lho nanti suka:v`")
